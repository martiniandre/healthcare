      ...
      <div className="overflow-x-auto w-full">
        {consultationsWeeklyData?.length ? (
          ...
          <div className="h-48 border-b border-border mb-2 pt-6">
            <EmptyState 
              title={translate("stats.empty.consultations") || "Sem consultas"} 
              description={translate("stats.empty.consultationsDesc") || "Nenhum dado de consulta disponível para o período."} 
              className="h-full"
            />
          </div>
        )}
