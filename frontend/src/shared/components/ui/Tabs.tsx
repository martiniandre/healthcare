...
>(({ className, ...properties }, reference) => (
  <TabsPrimitive.List
    ref={reference}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-muted-soft p-1 text-muted-foreground",
      className
    )}
    {...properties}
  />
...
>(({ className, ...properties }, reference) => (
  <TabsPrimitive.Content
    ref={reference}
    className={cn(
      "mt-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30",
      className
    )}
    {...properties}
  />
