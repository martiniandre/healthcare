...
- Name: telemetry_stats_staff.spec.ts >> Hospital Staff Management Module >> should render the staff members list page
- Location: e2e\telemetry_stats_staff.spec.ts:93:3
...
Locator: locator('text=Dr. André Silva de Araujo')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Dr. André Silva de Araujo')
