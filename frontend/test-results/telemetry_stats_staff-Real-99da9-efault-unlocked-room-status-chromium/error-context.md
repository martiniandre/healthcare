...
- Name: telemetry_stats_staff.spec.ts >> Real-time Telemetry Dashboard Module >> should display telemetry rooms and default unlocked room status
- Location: e2e\telemetry_stats_staff.spec.ts:10:3
...
Locator: getByRole('heading', { name: 'Sala Verde - Semi-Intensiva' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Sala Verde - Semi-Intensiva' })
...
- main:
  - heading "Central de Monitoramento e Telemetria" [level=2]
  - text: Monitoramento de sinais vitais organizado por alas e salas protegidas por senha de plantão
  - button "Alarmes Silenciados"
  - text: Nenhum leito ativo nesta sala de monitoramento.
```
