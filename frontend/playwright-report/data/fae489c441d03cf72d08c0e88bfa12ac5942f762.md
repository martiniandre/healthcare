...
- Name: telemetry_stats_staff.spec.ts >> Real-time Telemetry Dashboard Module >> should handle room unlocking workflow with passcode verification
- Location: e2e\telemetry_stats_staff.spec.ts:21:3
...
Call log:
  - waiting for getByRole('heading', { name: 'Sala Vermelha - Choque & Emergência' })
...
- generic [ref=e6]:
  - generic [ref=e7]:
    ...
    - paragraph [ref=e12]: Portal de Acesso Médico Integrado ao Barramento FHIR
  - generic [ref=e13]:
    - heading "Autenticação Clínica" [level=2] [ref=e14]
    - generic [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]:
          - img [ref=e18]
          - text: E-mail Profissional
        - textbox "nome.sobrenome@hospital.com" [ref=e22]
      - generic [ref=e23]:
        - generic [ref=e24]:
          - img [ref=e25]
          - text: Senha de Acesso
        - textbox "••••••••" [ref=e29]
      - button "Entrar no Console" [ref=e30] [cursor=pointer]
  - paragraph [ref=e31]:
    - text: Uso restrito a funcionários autorizados do ecossistema hospitalar.
    - text: Todas as conexões e acessos são auditados conforme diretrizes da LGPD/HIPAA.
```
