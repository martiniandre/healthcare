...
- Name: exam_analyzer.spec.ts >> Exam Analyzer Module >> should delete an analysis from history
- Location: e2e\exam_analyzer.spec.ts:53:3
...
Call log:
  - waiting for locator('div').filter({ hasText: 'rx_torax.png' }).first().locator('button.text-gray-400').first()
    - locator resolved to <button class="p-1.5 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-50 md:hidden">…</button>
