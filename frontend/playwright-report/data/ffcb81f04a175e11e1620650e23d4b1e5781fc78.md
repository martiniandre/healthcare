...
- Name: telemetry_stats_staff.spec.ts >> Hospital Staff Management Module >> should successfully register a new hospital practitioner
- Location: e2e\telemetry_stats_staff.spec.ts:112:3
...
Locator: locator('text=Dra. Paula Albuquerque')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Dra. Paula Albuquerque')
...
- main:
  ...
  - textbox "Buscar por nome, e-mail ou especialidade..."
  - button "Todos"
  - button "Médico"
  - button "Enfermeiro"
  - button "Recepção"
  ...
  - heading "Cadastrar Novo Profissional" [level=3]
  - button
  - text: Nome Completo
  - 'textbox "Ex: Dr. André Silva de Araujo"': Dra. Paula Albuquerque
  - text: Categoria
  - combobox:
    - option "Médico" [selected]
    - option "Enfermeiro"
    - option "Recepção"
    - option "Administrativo"
  - text: Registro Profissional
  - 'textbox "Ex: CRM-SP 12345"': CRM-SP 777777
  - text: E-mail Corporativo
  - 'textbox "Ex: nome@hospital.com"': paula.albuquerque@hospital.com
  - text: Departamento
  - 'textbox "Ex: Cardiologia"': Neurologia
  - button "Cancelar"
  - button "Salvar Cadastro"
- text: Erro
- paragraph: Falha ao registrar profissional de saúde.
- button
```
